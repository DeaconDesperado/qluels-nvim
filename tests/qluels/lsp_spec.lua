...
describe("qluels.lsp", function()
  describe("get_client", function()
    it("returns nil when no qlue_ls client is attached", function()
  ...
  describe("is_attached", function()
    it("returns false when no qlue_ls client is attached", function()
  ...
  describe("add_backend", function()
    it("returns false when qlue_ls is not attached", function()
      local params = {
        service = {
          name = "test",
